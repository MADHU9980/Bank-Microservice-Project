...
@Tag(name = "CRUD REST APIs for Accounts in ING Bank", description = "CRUD REST APIs in ING Bank to CREATE, UPDATE, FETCH AND DELETE account details")
...
public class AccountsController {
	...
	@Value("#{environment.getProperty('build.version')}")
	...
	@Operation(summary = "Create Account REST API", description = "REST API to create new Customer &  Account inside ING Bank")
	...
	@ApiResponses({ @ApiResponse(responseCode = "200", description = "HTTP Status OK"),
			@ApiResponse(responseCode = "500", description = "HTTP Status Internal Server Error", content = @Content(schema = @Schema(implementation = ErrorResponseDto.class))) })
	@GetMapping("/fetch") // http://localhost:8080/api/fetch?mobileNumber=9980413798
