...
@Tag(
        name = "CRUD REST APIs for Loans in ING Bank",
        description = "CRUD REST APIs in ING Bank to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
...
public class LoansController {
    ...
    @Operation(
            ...
            description = "REST API to create new loan inside ING Bank"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
